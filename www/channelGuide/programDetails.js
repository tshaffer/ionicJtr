...
angular.module('jtr.controllers')
  ...
  .controller('ProgramDetailsCtrl', function($rootScope, $scope, $location, $stateParams, jtrSettingsService, jtrServerService, jtrCGServices, jtrStationsService, jtrSettingsService) {
